...
# The below defined function 'Exper2' generates a polynomial P of degree 'deg_of_poly' which is product of 'deg_of_poly' linear polynomials. Ex: if deg_of_poly=2 then P=l1*l2. Additionally, it calculates the deg_of_poly+1 iterative derivatives of order deg_of_poly-1. And then checks whether linear polynomials lies in the span of derivatives or not.
def Exper2(deg_of_poly):
	...
	print l
	Der=[]
	# Calculate the iterative derivatives and store the dervatives in the list 'Der'
	...
	arr=matrix(GF(p),Der)
	print arr
	# Check that does linear polynomials in 'l' lies in the span of derivatives or not
